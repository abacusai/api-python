...
class MessagingConnectorResponse(AbstractApiClass):
    ...
    def __init__(self, client, welcomeMessage=None, defaultMessage=None, disclaimer=None, messagingBotName=None, useDefaultLabel=None):
    ...
    def __repr__(self):
        repr_dict = {f'welcome_message': repr(self.welcome_message), f'default_message': repr(self.default_message), f'disclaimer': repr(
            self.disclaimer), f'messaging_bot_name': repr(self.messaging_bot_name), f'use_default_label': repr(self.use_default_label)}
    ...
    def to_dict(self):
        ...
        resp = {'welcome_message': self.welcome_message, 'default_message': self.default_message, 'disclaimer': self.disclaimer,
                'messaging_bot_name': self.messaging_bot_name, 'use_default_label': self.use_default_label}
