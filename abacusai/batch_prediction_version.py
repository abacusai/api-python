...
class BatchPredictionVersion():
    ...
    def describe(self):
        return self.client.describe_batch_prediction_version(self.batch_prediction_version, batch_prediction_version)
