...
class ModelMonitorOrgSummary(AbstractApiClass):
    ...
    def __init__(self, client, summary=None, featureDrift=None, labelDrift=None, dataIntegrity=None, performance=None, alerts=None, mostRecentMonitorInfo=None, totalStarredMonitors=None):
    ...
    def to_dict(self):
        ...
        """
        return {'summary': self.summary, 'feature_drift': self.feature_drift, 'label_drift': self.label_drift, 'data_integrity': self.data_integrity, 'performance': self.performance, 'alerts': self.alerts, 'most_recent_monitor_info': self.most_recent_monitor_info, 'total_starred_monitors': self.total_starred_monitors}
