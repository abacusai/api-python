...
class FeatureDriftSummary(AbstractApiClass):
    ...
    def __init__(self, client, featureIndex=None, name=None, distance=None, jsDistance=None, wsDistance=None, ksStatistic=None, predictionDrift=None, targetColumn=None, dataIntegrityTimeseries=None, nullViolations={}, typeViolations={}, rangeViolations={}, catViolations={}):
