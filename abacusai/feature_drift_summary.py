...
class FeatureDriftSummary(AbstractApiClass):
    ...
    def __init__(self, client, featureIndex=None, name=None, distance=None, predictionDrift=None, targetColumn=None, nullViolations={}, typeViolations={}, rangeViolations={}, catViolations={}):
