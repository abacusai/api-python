...
class ExternalApplication(AbstractApiClass):
    """
        ...
        Args:
            ...
            hasEffortOption (bool): Whether the external application has an effort option.
            availableEffortLevels (list): List of available effort levels for the model (e.g. ['low', 'high']).
            ...
            urlPath (str): A short URL-friendly path for the external application. Only set for system created bots.
            deepagentEffortModes (list): List of available effort modes for the Deep Agent. Only applicable for super agent applications.
            defaultDeepagentEffortMode (str): The default effort mode for the Deep Agent. Only applicable for super agent applications.
    """

    def __init__(self, client, name=None, externalApplicationId=None, deploymentId=None, description=None, logo=None, theme=None, userGroupIds=None, useCase=None, isAgent=None, status=None, deploymentConversationRetentionHours=None, managedUserService=None, predictionOverrides=None, isSystemCreated=None, isCustomizable=None, isDeprecated=None, isVisible=None, hasThinkingOption=None, hasFastMode=None, hasEffortOption=None, availableEffortLevels=None, onlyImageGenEnabled=None, projectId=None, isCodellmChatmodeSupported=None, urlPath=None, deepagentEffortModes=None, defaultDeepagentEffortMode=None):
        ...
        self.has_effort_option = hasEffortOption
        self.available_effort_levels = availableEffortLevels
    ...
    def to_dict(self):
        ...
        resp = {'name': self.name, 'external_application_id': self.external_application_id, 'deployment_id': self.deployment_id, 'description': self.description, 'logo': self.logo, 'theme': self.theme, 'user_group_ids': self.user_group_ids, 'use_case': self.use_case, 'is_agent': self.is_agent, 'status': self.status, 'deployment_conversation_retention_hours': self.deployment_conversation_retention_hours, 'managed_user_service': self.managed_user_service, 'prediction_overrides': self.prediction_overrides, 'is_system_created': self.is_system_created, 'is_customizable': self.is_customizable,
                'is_deprecated': self.is_deprecated, 'is_visible': self.is_visible, 'has_thinking_option': self.has_thinking_option, 'has_fast_mode': self.has_fast_mode, 'has_effort_option': self.has_effort_option, 'available_effort_levels': self.available_effort_levels, 'only_image_gen_enabled': self.only_image_gen_enabled, 'project_id': self.project_id, 'is_codellm_chatmode_supported': self.is_codellm_chatmode_supported, 'url_path': self.url_path, 'deepagent_effort_modes': self.deepagent_effort_modes, 'default_deepagent_effort_mode': self.default_deepagent_effort_mode}
