...
class BotInfo(AbstractApiClass):
    ...
    def __init__(self, client, externalApplicationId=None, deploymentId=None, agentTasksExhausted=None, externalApplication={}):
    ...
    def __repr__(self):
        repr_dict = {f'external_application_id': repr(self.external_application_id), f'deployment_id': repr(
            self.deployment_id), f'agent_tasks_exhausted': repr(self.agent_tasks_exhausted), f'external_application': repr(self.external_application)}
        class_name = "BotInfo"
    ...
    def to_dict(self):
        ...
        resp = {'external_application_id': self.external_application_id, 'deployment_id': self.deployment_id,
                'agent_tasks_exhausted': self.agent_tasks_exhausted, 'external_application': self._get_attribute_as_dict(self.external_application)}
