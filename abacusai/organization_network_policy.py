...
class OrganizationNetworkPolicy(AbstractApiClass):
    ...
    def __init__(self, client, enabled=None, lifecycle=None, egressFqdns=None, egressCidrs=None, updatedAt=None, available=None):
        super().__init__(client, None)
        self.enabled = enabled
        self.lifecycle = lifecycle
        self.egress_fqdns = egressFqdns
        self.egress_cidrs = egressCidrs
    ...
    def __repr__(self):
        repr_dict = {f'enabled': repr(self.enabled), f'lifecycle': repr(self.lifecycle), f'egress_fqdns': repr(
            self.egress_fqdns), f'egress_cidrs': repr(self.egress_cidrs), f'updated_at': repr(self.updated_at), f'available': repr(self.available)}
    ...
    def to_dict(self):
        ...
        """
        resp = {'enabled': self.enabled, 'lifecycle': self.lifecycle, 'egress_fqdns': self.egress_fqdns,
                'egress_cidrs': self.egress_cidrs, 'updated_at': self.updated_at, 'available': self.available}
