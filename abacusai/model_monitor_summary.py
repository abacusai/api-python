...
class ModelMonitorSummary(AbstractApiClass):
    ...
    def __init__(self, client, modelAccuracy=None, modelDrift=None, dataIntegrity=None, biasViolations=None):
    ...
    def to_dict(self):
        ...
        """
        return {'model_accuracy': self.model_accuracy, 'model_drift': self.model_drift, 'data_integrity': self.data_integrity, 'bias_violations': self.bias_violations}
