...
class NotebookTemplate(AbstractApiClass):
    ...
    def __init__(self, client, notebookTemplateId=None, name=None, description=None, createdAt=None, updatedAt=None, templateType=None, filename=None, sourceCode=None, tags=None):
