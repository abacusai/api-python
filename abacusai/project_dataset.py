...
class ProjectDataset(AbstractApiClass):
    ...
    def __init__(self, client, name=None, featureGroupTableName=None, datasetType=None, datasetId=None, streaming=None, dataFilters={}):
    ...
    def to_dict(self):
        ...
        """
        return {'name': self.name, 'feature_group_table_name': self.feature_group_table_name, 'dataset_type': self.dataset_type, 'dataset_id': self.dataset_id, 'streaming': self.streaming, 'data_filters': self._get_attribute_as_dict(self.data_filters)}
