...
class GraphDashboard(AbstractApiClass):
    ...
    def __init__(self, client, name=None, graphDashboardId=None, createdAt=None, projectId=None, pythonFunctionIds=None, pythonFunctionNames=None, projectName=None):
    ...
    def to_dict(self):
        ...
        """
        return {'name': self.name, 'graph_dashboard_id': self.graph_dashboard_id, 'created_at': self.created_at, 'project_id': self.project_id, 'python_function_ids': self.python_function_ids, 'python_function_names': self.python_function_names, 'project_name': self.project_name}
    ...
    def update(self, name: str = None, python_function_ids: list = None, variable_mappings: dict = None):
        """
        ...
        Returns:
            GraphDashboard: An object describing the graph dashboard
        """
        return self.client.update_graph_dashboard(self.graph_dashboard_id, name, python_function_ids, variable_mappings)
